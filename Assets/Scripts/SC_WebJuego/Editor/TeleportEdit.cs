...
{
    using System.IO;
    using global::WebGame.Game.Mechanical;

    [CustomEditor(typeof(TeleportEvent) , true)]
    [CanEditMultipleObjects]
    public class TeleportEdit : Editor
    {
        #region Attributes
        bool _doOnce;
        ...
        public override void OnInspectorGUI()
        {
            ...
            TeleportEvent script = target as TeleportEvent;
            ...
            script._destiniTeleport = EditorGUILayout.ObjectField("Destiny to teleport" , script._destiniTeleport , typeof(GameObject) , true) as GameObject;
            if ( _isFlipFlop )
            {
