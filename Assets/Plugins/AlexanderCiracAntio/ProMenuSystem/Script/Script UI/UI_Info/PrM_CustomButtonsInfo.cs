...
namespace AlexanderCA.ProMenu.UI
{
    ...
    [System.Serializable]
    public struct PrM_CustomButtonsInfo
    {
        ...
        [System.Serializable]
        public struct PersonalizarExplicacion
        {
        ...
        #region Spanish
        [System.Serializable]
        public struct PersonalizarEspañol
        {
        ...
        [System.Serializable]
        public struct PersonalizarTotalEspañol
        {
#if UNITY_EDITOR
        ...
        [System.Serializable]
        public struct PersonalizarUsoEspañol
        {
#if UNITY_EDITOR
        ...
        [System.Serializable]
        public struct PersonalizarAdvertenciaEspañol
        {
#if UNITY_EDITOR
        ...
        #region English
        [System.Serializable]
        public struct PersonalizarIngles
        {
        ...
        [System.Serializable]
        public struct PersonalizarTotalIngles
        {
#if UNITY_EDITOR
        ...
        [System.Serializable]
        public struct PersonalizarUsoIngles
        {
#if UNITY_EDITOR
        ...
        [System.Serializable]
        public struct PersonalizarAdvertenciaIngles
        {
#if UNITY_EDITOR
        ...
        [System.Serializable]
        public struct PersonalizarJuego
        {
        ...
        [System.Serializable]
        public struct PersonalizarGeneruci
        {
        ...
        [System.Serializable]
        public struct BotonesPersonalizar
        {
        ...
        public void GetErrorGeneric(int i , int intGeneric = 0)
        {
            ...
            if ( _content._customDefault.Length < intGeneric )
            {
                Debug.LogWarning(SceneManager.GetActiveScene().name + "(PrM_UIManager)---->Option 5:Español:La ID colocado en <Custom defoult> no existe en la lista " + "Element: " + i.ToString() + "\n" + "English:English:The ID placed in <Custom default> does not exist in the list " + "Element: " + i.ToString());
            }
