...
namespace AlexanderCA.ProMenu.UI
{
    ...
    [System.Serializable]
    public struct PrM_PauseGameInfo
    {
        ...
        [System.Serializable]
        public struct ExplicacionBotonPausaJuego
        {
        ...
        #region Español
        [System.Serializable]
        public struct ExplicacionBotonPausaJuegoEspañol
        {
        ...
        [System.Serializable]
        public struct BotonPausaJuegoTotalEspañol
        {
#if UNITY_EDITOR
        ...
        [System.Serializable]
        public struct BotonPausaJuegoUsoEspañol
        {
#if UNITY_EDITOR
        ...
        [System.Serializable]
        public struct BotonPausaJuegoAdvertenciaEspañol
        {
#if UNITY_EDITOR
        ...
        #region English
        [System.Serializable]
        public struct ExplicacionBotonPausaJuegoIngles
        {
        ...
        [System.Serializable]
        public struct BotonPausaJuegoTotalIngles
        {
#if UNITY_EDITOR
        ...
        [System.Serializable]
        public struct BotonPausaJuegoUsoIngles
        {
#if UNITY_EDITOR
        ...
        [System.Serializable]
        public struct BotonPausaJuegoAdverteciaIngles
        {
#if UNITY_EDITOR
        ...
        [System.Serializable]
        public struct BotonPausaJuegoContenido
        {
        ...
        [System.Serializable]
        public struct BotonPausaJuegoConBoton
        {
        ...
        [System.Serializable]
        public struct BotonPausaJuegoConTecla
        {
        ...
        public void GetPauseGameError()
        {
            ...
            //error buttons
            if ( _quitContent._showButton != null && _quitContent._hiddeButton != null && _quitContent._showButton == _quitContent._hiddeButton )
            {
                Debug.LogError(SceneManager.GetActiveScene().name + " (PrM_UIManager)---->Opcion 2:Español: No puedes usar el mismo botón en el otro lado" + "\n" + "English:You can't use the same button on the other side");
            }
