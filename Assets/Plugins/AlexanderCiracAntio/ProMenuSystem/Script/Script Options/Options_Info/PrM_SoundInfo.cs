...
namespace AlexanderCA.ProMenu.Opciones
{
    ...
    public struct PrM_SoundInfo
    {
        #region Brightness Explanation
          ...
          [System.Serializable]
          public struct ExplicacionSonido
          {
          ...
          #region Spanish
            [System.Serializable]
            public struct ExplicacionSonidoEspañol
            {
            ...
            [System.Serializable]
            public struct ExplicacionSonidoTotalEspañol
            {
              #if UNITY_EDITOR
            ...
            [System.Serializable]
            public struct ExplicacionSonidoUsoEspañol
            {
              #if UNITY_EDITOR
            ...
            [System.Serializable]
            public struct ExplicacionSonidoAdvertenciaEspañol
            {
              #if UNITY_EDITOR
          ...
          #region English
            [System.Serializable]
            public struct ExplicacionSonidoIngles
            {
            ...
            [System.Serializable]
            public struct ExplicacionSonidoTotalIngles
            {
              #if UNITY_EDITOR
            ...
            [System.Serializable]
            public struct ExplicacionSonidoUsoIngles
            {
              #if UNITY_EDITOR
            ...
            [System.Serializable]
            public struct ExplicacionSonidoAdvertenciIngles
            {
              #if UNITY_EDITOR
        ...
        /// </summary>        
        public void GetErrorSound(int _i, int listSound = -1)
        {
            ...
            if ( listSound != -1 &&  m_Contenido.m_Sonido[_i]._audioSource[listSound] == null )
            {
                Debug.LogWarning(SceneManager.GetActiveScene().name + " (SC_MenuProOpciones)---->Opcion 2:Ha desaparecidola referecia del <AudioSource>  " + _element +  "\n" + "English:The <AudioSource> reference has disappeared " + _element);
            }
        }
    #endregion
